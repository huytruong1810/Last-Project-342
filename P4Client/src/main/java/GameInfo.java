...
public class GameInfo implements Serializable {
     ...
     */
    int gameMode, clientNum, numLetter, numRemainGuess, numRemainAttempt, charLocation;
    /**
     * category:
     * D := Disaster
     * M := Mythical creature
    ...
    GameInfo (int gameMode, int clientNum, int numLetter, int numRemainGuess, int numRemainAttempt,
        ...
        this.numRemainAttempt = numRemainAttempt;
